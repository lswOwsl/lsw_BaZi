...
public class Default {
    ...
    public static int getHexagramBodyIndex(int earthlyBranchId) {
//            子午持世身居初，丑未持世身居二，
//            寅申持世身居三，卯酉持世身居四，
//            辰戌持世身居五，巳亥持世身居六。
        //17,28
        //39,410
        //511,612
        return earthlyBranchId > 6 ? earthlyBranchId - 6 : earthlyBranchId;
    }
    ...
    private static HexagramDefault createHexagram(int id, String name, String upperPart, String lowerPart, boolean side, String place,
    ...
    public static ArrayList<HexagramDefault> getHexagrams() {
        if (hexagrams == null) {
            ...
            hexagrams.add(createHexagram(1, "乾", "天", "天", true, "乾", 7, 7, 7, 7, 7, 7, 6, 3));
            hexagrams.add(createHexagram(2, "姤", "天", "风", true, "乾", 8, 7, 7, 7, 7, 7, 1, 4));
            hexagrams.add(createHexagram(3, "遁", "天", "山", true, "乾", 8, 8, 7, 7, 7, 7, 2, 5));
            hexagrams.add(createHexagram(4, "否", "天", "地", true, "乾", 8, 8, 8, 7, 7, 7, 3, 6));
            hexagrams.add(createHexagram(5, "观", "风", "地", true, "乾", 8, 8, 8, 8, 7, 7, 4, 1));
            hexagrams.add(createHexagram(6, "剥", "山", "地", true, "乾", 8, 8, 8, 8, 8, 7, 5, 2));
            hexagrams.add(createHexagram(7, "晋", "火", "地", true, "乾", 8, 8, 8, 7, 8, 7, 4, 1));
            hexagrams.add(createHexagram(8, "大有", "火", "天", true, "乾", 7, 7, 7, 7, 8, 7, 3, 6));
            hexagrams.add(createHexagram(9, "坎", "水", "水", true, "坎", 8, 7, 8, 8, 7, 8, 6, 3));
            hexagrams.add(createHexagram(10, "节", "水", "泽", true, "坎", 7, 7, 8, 8, 7, 8, 1, 4));
            hexagrams.add(createHexagram(11, "屯", "水", "雷", true, "坎", 7, 8, 8, 8, 7, 8, 2, 5));
            hexagrams.add(createHexagram(12, "既济", "水", "火", true, "坎", 7, 8, 7, 8, 7, 8, 3, 6));
            hexagrams.add(createHexagram(13, "革", "泽", "火", true, "坎", 7, 8, 7, 7, 7, 8, 4, 1));
            hexagrams.add(createHexagram(14, "丰", "雷", "火", true, "坎", 7, 8, 7, 7, 8, 8, 5, 2));
            hexagrams.add(createHexagram(15, "明夷", "地", "火", true, "坎", 7, 8, 7, 8, 8, 8, 4, 1));
            hexagrams.add(createHexagram(16, "师", "地", "水", true, "坎", 8, 7, 8, 8, 8, 8, 3, 6));
            hexagrams.add(createHexagram(17, "艮", "山", "山", true, "艮", 8, 8, 7, 8, 8, 7, 6, 3));
            hexagrams.add(createHexagram(18, "贲", "山", "火", true, "艮", 7, 8, 7, 8, 8, 7, 1, 4));
            hexagrams.add(createHexagram(19, "大畜", "山", "天", true, "艮", 7, 7, 7, 8, 8, 7, 2, 5));
            hexagrams.add(createHexagram(20, "损", "山", "泽", true, "艮", 7, 7, 8, 8, 8, 7, 3, 6));
            hexagrams.add(createHexagram(21, "睽", "火", "泽", true, "艮", 7, 7, 8, 7, 8, 7, 4, 1));
            hexagrams.add(createHexagram(22, "履", "天", "泽", true, "艮", 7, 7, 8, 7, 7, 7, 5, 2));
            hexagrams.add(createHexagram(23, "中孚", "风", "泽", true, "艮", 7, 7, 8, 8, 7, 7, 4, 1));
            hexagrams.add(createHexagram(24, "渐", "风", "山", true, "艮", 8, 8, 7, 8, 7, 7, 3, 6));
            hexagrams.add(createHexagram(25, "震", "雷", "雷", true, "震", 7, 8, 8, 7, 8, 8, 6, 3));
            hexagrams.add(createHexagram(26, "豫", "雷", "地", true, "震", 8, 8, 8, 7, 8, 8, 1, 4));
            hexagrams.add(createHexagram(27, "解", "雷", "水", true, "震", 8, 7, 8, 7, 8, 8, 2, 5));
            hexagrams.add(createHexagram(28, "恒", "雷", "风", true, "震", 8, 7, 7, 7, 8, 8, 3, 6));
            hexagrams.add(createHexagram(29, "升", "地", "风", true, "震", 8, 7, 7, 8, 8, 8, 4, 1));
            hexagrams.add(createHexagram(30, "井", "水", "风", true, "震", 8, 7, 7, 8, 7, 8, 5, 2));
            hexagrams.add(createHexagram(31, "大过", "泽", "风", true, "震", 8, 7, 7, 7, 7, 8, 4, 1));
            hexagrams.add(createHexagram(32, "随", "泽", "雷", true, "震", 7, 8, 8, 7, 7, 8, 3, 6));
            hexagrams.add(createHexagram(33, "巽", "风", "风", false, "巽", 8, 7, 7, 8, 7, 7, 6, 3));
            hexagrams.add(createHexagram(34, "小畜", "风", "天", false, "巽", 7, 7, 7, 8, 7, 7, 1, 4));
            hexagrams.add(createHexagram(35, "家人", "风", "火", false, "巽", 7, 8, 7, 8, 7, 7, 2, 5));
            hexagrams.add(createHexagram(36, "益", "风", "雷", false, "巽", 7, 8, 8, 8, 7, 7, 3, 6));
            hexagrams.add(createHexagram(37, "无妄", "天", "雷", false, "巽", 7, 8, 8, 7, 7, 7, 4, 1));
            hexagrams.add(createHexagram(38, "噬嗑", "火", "雷", false, "巽", 7, 8, 8, 7, 8, 7, 5, 2));
            hexagrams.add(createHexagram(39, "颐", "山", "雷", false, "巽", 7, 8, 8, 8, 8, 7, 4, 1));
            hexagrams.add(createHexagram(40, "蛊", "山", "风", false, "巽", 8, 7, 7, 8, 8, 7, 3, 6));
            hexagrams.add(createHexagram(41, "离", "火", "火", false, "离", 7, 8, 7, 7, 8, 7, 6, 3));
            hexagrams.add(createHexagram(42, "旅", "火", "山", false, "离", 8, 8, 7, 7, 8, 7, 1, 4));
            hexagrams.add(createHexagram(43, "鼎", "火", "风", false, "离", 8, 7, 7, 7, 8, 7, 2, 5));
            hexagrams.add(createHexagram(44, "未济", "火", "水", false, "离", 8, 7, 8, 7, 8, 7, 3, 6));
            hexagrams.add(createHexagram(45, "蒙", "山", "水", false, "离", 8, 7, 8, 8, 8, 7, 4, 1));
            hexagrams.add(createHexagram(46, "涣", "风", "水", false, "离", 8, 7, 8, 8, 7, 7, 5, 2));
            hexagrams.add(createHexagram(47, "讼", "天", "水", false, "离", 8, 7, 8, 7, 7, 7, 4, 1));
            hexagrams.add(createHexagram(48, "同人", "天", "火", false, "离", 7, 8, 7, 7, 7, 7, 3, 6));
            hexagrams.add(createHexagram(49, "坤", "地", "地", false, "坤", 8, 8, 8, 8, 8, 8, 6, 3));
            hexagrams.add(createHexagram(50, "复", "地", "雷", false, "坤", 7, 8, 8, 8, 8, 8, 1, 4));
            hexagrams.add(createHexagram(51, "临", "地", "泽", false, "坤", 7, 7, 8, 8, 8, 8, 2, 5));
            hexagrams.add(createHexagram(52, "泰", "地", "天", false, "坤", 7, 7, 7, 8, 8, 8, 3, 6));
            hexagrams.add(createHexagram(53, "大壮", "雷", "天", false, "坤", 7, 7, 7, 7, 8, 8, 4, 1));
            hexagrams.add(createHexagram(54, "夬", "泽", "天", false, "坤", 7, 7, 7, 7, 7, 8, 5, 2));
            hexagrams.add(createHexagram(55, "需", "水", "天", false, "坤", 7, 7, 7, 8, 7, 8, 4, 1));
            hexagrams.add(createHexagram(56, "比", "水", "地", false, "坤", 8, 8, 8, 8, 7, 8, 3, 6));
            hexagrams.add(createHexagram(57, "兑", "泽", "泽", false, "兑", 7, 7, 8, 7, 7, 8, 6, 3));
            hexagrams.add(createHexagram(58, "困", "泽", "水", false, "兑", 8, 7, 8, 7, 7, 8, 1, 4));
            hexagrams.add(createHexagram(59, "萃", "泽", "地", false, "兑", 8, 8, 8, 7, 7, 8, 2, 5));
            hexagrams.add(createHexagram(60, "咸", "泽", "山", false, "兑", 8, 8, 7, 7, 7, 8, 3, 6));
            hexagrams.add(createHexagram(61, "蹇", "水", "山", false, "兑", 8, 8, 7, 8, 7, 8, 4, 1));
            hexagrams.add(createHexagram(62, "谦", "地", "山", false, "兑", 8, 8, 7, 8, 8, 8, 5, 2));
            hexagrams.add(createHexagram(63, "小过", "雷", "山", false, "兑", 8, 8, 7, 7, 8, 8, 4, 1));
            hexagrams.add(createHexagram(64, "归妹", "雷", "泽", false, "兑", 7, 7, 8, 7, 8, 8, 3, 6));
        }
